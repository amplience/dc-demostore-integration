...
exports.getCommerceAPI = exports.getConfig = void 0;
const amplience_1 = require("../amplience");
const axios_1 = __importDefault(require("axios"));
const index_1 = require("../index");
const index_2 = require("../index");
const getConfig = (configLocator) => __awaiter(void 0, void 0, void 0, function* () { return yield new amplience_1.AmplienceClient(configLocator).getConfig(); });
...
const getAPI = (config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return configLocator ?
        yield (0, index_1.getCodec)((yield (0, exports.getConfig)(configLocator)).commerce) :
