...
exports.ctoolsCustomerGroups = exports.ctoolsCategories = exports.ctoolsSearchResult = exports.ctoolsProduct = void 0;
const ctoolsProduct = (id) => ({
    id: id,
    version: 24,
    productType: {
        typeId: 'product-type',
...
exports.ctoolsProduct = ctoolsProduct;
const ctoolsSearchResult = (total, pageSize, pageNumber, ids) => {
    ...
    return {
        ...
        count,
        total,
        results: Array.from({ length: count }).map((_, index) => (0, exports.ctoolsProduct)(ids ? ids[index] : 'Hit' + (pageBase + index))),
        facets: {},
    };
};
exports.ctoolsSearchResult = ctoolsSearchResult;
exports.ctoolsCategories = {
    limit: 500,
    offset: 0,
    count: 1,
    total: 1,
