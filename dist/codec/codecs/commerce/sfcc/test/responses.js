...
exports.sfccCustomerGroups = exports.sfccCategories = exports.sfccSearchResult = exports.sfccProducts = exports.sfccProduct = exports.sfccSearchHit = void 0;
...
exports.sfccSearchHit = sfccSearchHit;
...
exports.sfccProduct = sfccProduct;
const sfccProducts = (prefix, total) => {
    ...
    for (let i = 0; i < total; i++) {
        result[`https://test.sandbox.us03.dx.commercecloud.salesforce.com/s/TestSite/dw/shop/v22_4/products/${prefix + i}`] = {
            data: (0, exports.sfccProduct)(prefix + i),
        };
    }
    return result;
};
exports.sfccProducts = sfccProducts;
const sfccSearchResult = (total, pageSize, pageNumber, categorySlug) => {
    ...
    return {
        ...
        count: count,
        hits: Array.from({ length: count }).map((_, index) => (0, exports.sfccSearchHit)('Hit' + (pageBase + index), categorySlug)),
        refinements: [
            {
...
exports.sfccSearchResult = sfccSearchResult;
exports.sfccCategories = {
    _v: '22.4',
    _type: 'category',
    categories: [
        {
