...
exports.bigcommerceCustomerGroups = exports.bigcommerceCategories = exports.bigcommerceSearchResult = exports.bigcommerceProduct = void 0;
// TODO
...
// TODO
const bigcommerceSearchResult = (total, pageSize, pageNumber, ids) => {
    ...
    return {
        ...
        count,
        total,
        results: Array.from({ length: count }).map((_, index) => (0, exports.bigcommerceProduct)(ids ? ids[index] : 'Hit' + (pageBase + index))),
        facets: {},
    };
};
exports.bigcommerceSearchResult = bigcommerceSearchResult;
