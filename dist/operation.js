    ...
    doRequest(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let requestParams = { url, method: context.method, headers: yield this.getHeaders(), data: context.args.body };
                console.log(`[ ${context.method.toUpperCase()} ] ${requestParams.url}`);
                // next, execute the request with headers gotten from the backend
                let response = yield request(Object.assign(Object.assign({}, requestParams), { httpsAgent }));
